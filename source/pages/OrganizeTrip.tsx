                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-green-700 mt-2">
                          {formatAmount(currentDestination.price, currency)}
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <SelectContent>
                        {availableAccommodations.map(accommodation => (
                          <SelectItem key={accommodation.id} value={accommodation.id}>
                            {accommodation.name} - {formatAmount(accommodation.pricePerNight, currency)}/nuit
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                      ...
                      <SelectContent>
                        {availableRestaurants.map(restaurant => (
                          <SelectItem key={restaurant.id} value={restaurant.id}>
                            {restaurant.name} - {restaurant.cuisine} - {formatAmount(restaurant.pricePerMeal, currency)}/repas
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                      ...
                      <SelectContent>
                        {availableTransports.map(transport => (
                          <SelectItem key={transport.id} value={transport.id}>
                            {transport.name} - {formatAmount(transport.price, currency)}
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-lg font-bold">
                        <span>Total:</span>
                        <span className="text-green-600">{formatAmount(calculateTotal(), currency)}</span>
                      </div>
